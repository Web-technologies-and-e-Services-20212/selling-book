            ...
            <div class="list-products-wrapper flex">
                ...
                <div class="list-pro grid-r4m3">
                    ...
                    <div class="pagination flex f-space_between f-align_center p-lr16 p-tb16">
                        ...
                        style="visibility: 
                        <?php if($currentPage == 1) echo "hidden"; else echo "visible" ?>;">
                            <span>
                            <i class="fa-solid fa-chevron-left"></i>
                            </span>
                            <a href=<?php echo "/" . $path_project . "/list-products" ."/". $_category['route'] ."?page=" . ($currentPage - 1); ?>>Trang trước</a>
                        </div>
                            ...
                            <div class="flex">
                                <ul>
                                    <?php if($currentPage > 1) { ?>
                                        <li>
                                            <a href=<?php echo "/" . $path_project . "/list-products" ."/". $_category['route']; ?> >
                                            1
                                            </a>
                                        </li>
                                    <?php } ?>
                                    ...
                                    <?php if ($currentPage > 2) { ?>
                                        <li>
                                            <a href=<?php echo "/" . $path_project . "/list-products" ."/". $_category['route'] ."?page=" . ($currentPage - 1); ?> >
                                    ...
                                    <li class="active">
                                        <a href=<?php echo "/" . $path_project . "/list-products" . "/" . $_category['route'] . "?page=" . ($currentPage); ?>>
                                    ...
                                    <?php if ($currentPage + 1 < $totalPage) { ?>
                                        <li>
                                            <a href=<?php echo "/" . $path_project . "/list-products" . "/" . $_category['route'] . "?page=" . ($totalPage); ?>>
                                            <?php echo $totalPage; ?>
                                            </a>
                                        </li>
                                    <?php } ?>
                        ...
                        <?php if($currentPage == $totalPage) echo "hidden"; else echo "visible" ?>;">
                            <a href=<?php echo "/" . $path_project . "/list-products" . "/" . $_category['route'] .  "?page=" . ($currentPage + 1); ?>>Trang sau</a>
