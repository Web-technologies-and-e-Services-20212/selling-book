    ...
    <div class='dashboard'>
        ...
        <div>
            ...
            <div style="width: 80%; height: 150px;">
                <center>
                    <h1 style="color: rgb(50, 158, 98); padding: 20px;">PRODUCT MANAGEMENT</h1>
                </center>
            </div>
        </div>
        ...
        <div id='add_laptop' style=" display: none;">
            <div style="display: flex; background-color: rgb(97, 182, 133); border-top-left-radius: 20px; border-top-right-radius: 20px;">
                ...
                <div style="width: 80%;">
                    <center>
                        <h2 style="color:white;">ADD LAPTOP</h2>
                    </center>
                </div>
            </div>
            <div>
        ...
        <div id='add_pc' style=" display: none;">
            <div style="display: flex; background-color: rgb(97, 182, 133); border-top-left-radius: 20px; border-top-right-radius: 20px;">
                ...
                <div style="width: 80%;">
                    <center>
                        <h2 style="color:white;">ADD PC</h2>
                    </center>
                </div>
            </div>
            <div>
        ...
        <div id='add_mouse' style=" display: none;">
            <div style="display: flex; background-color: rgb(97, 182, 133); border-top-left-radius: 20px; border-top-right-radius: 20px;">
                ...
                <div style="width: 80%;">
                    <center>
                        <h2 style="color:white;">ADD MOUSE</h2>
                    </center>
                </div>
            </div>
            <div>
        ...
        <script>
            ...
            function upload_img(id_element) {
                ...
                fetch('library/admin/uploadImg.php', {
                    method: "POST",
                    body: formData
                });
            }
